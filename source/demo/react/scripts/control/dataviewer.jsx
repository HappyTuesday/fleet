...
var PagedLoadingView = React.createClass({
  ...
  render: function(){
    ...
    if((this.props.pageIndex+1) * this.props.pageSize < this.props.totalCount){
      morebtn = <button className="more" onClick={this.onMoreItems}>more...</button>;
    }
    var view = this.props.viewFactory({
      items: this.state.items,
      children: morebtn
    ...
    return (
      <div className="paged-loading-view">
        {view}
      </div>
    );
  },
...
var Table = React.createClass({
  ...
  render: function(){
    ...
    var childrenWrapper = React.Children.map(this.props.children,function(child){
      return (
        <Table.Row key="children-wrapper" item={child}
...
Table.HeadRow = React.createClass({
  ...
  render: function(){
    var list = this.props.columns.map(function(column){
      return (
        <Table.HeadCell key={this.props.getColumnKey(column)} column={column}
...
Table.Row = React.createClass({
  ...
  render: function(){
    ...
    var list = this.props.columns.map(function(column){
      ...
      return (
        <Table.Cell key={this.props.getColumnKey(column)} className={classes} item={this.props.item} column={column} selected={this.props.selected}
...
var ThrottledInput = React.createClass({
  ...
  render: function(){
    ...
    return (
      <input className="throttled-input" onChange={this.onChange} value={this.state.value} />
    );
  },
  onChange: function(e){
